...
class ENGINE_API URenderBase : public USubsystem
{
	...
	virtual UBOOL BoundVisible( FSceneNode* Frame, const FCoords& Bound, FSpanBuffer* SpanBuffer, FScreenBounds& Results )=0;
	...
	virtual void DrawCylinder( FSceneNode* Frame, FPlane Color, DWORD LineFlags, const FCoords& Location, FLOAT Radius, FLOAT Height, FLOAT )=0;
	virtual void DrawInterpolationPathSegment(FSceneNode* param_1, AInterpolationPoint* param_2, AInterpolationPoint* param_3, const FPlane& param_4, INT param_5)=0;
};
