...
CORE_API size_t appToAnsiInPlace(ANSICHAR* Dst, const TCHAR* Src, size_t MaxCount, bool DiscardIllegalSequences=false);
...
CORE_API size_t appFromAnsiInPlace(TCHAR* Dst, const ANSICHAR* Src, size_t MaxCount, bool DiscardIllegalSequences=false);

// Converts C++ wchar to UTF-16LE
CORE_API size_t appToUnicodeInPlace(UNICHAR* Dst, const TCHAR* Src, size_t MaxCount, bool DiscardIllegalSequences=false);
// Converts UTF-16LE to C++ wchar
CORE_API size_t appFromUnicodeInPlace(TCHAR* Dst, const UNICHAR* Src, size_t MaxCount, bool DiscardIllegalSequences=false);

// Converts C++ wchar to UTF-8
CORE_API size_t appToUtf8InPlace(ANSICHAR* Dst, const TCHAR* Src, size_t MaxCount, bool DiscardIllegalSequences=false);
// Converts UTF-8 to C++ wchar
CORE_API size_t appFromUtf8InPlace(TCHAR* Dst, const ANSICHAR* Src, size_t MaxCount, bool DiscardIllegalSequences=false);
