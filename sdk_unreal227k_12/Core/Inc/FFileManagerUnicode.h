...
public:
	...
	void WriteString(const TCHAR* C)
	{
		...
		FromTcharFunc(Tmp, C, (Len + 1) * MaxSerializedCharLen, true);
...
protected:
	...
	size_t(*FromTcharFunc) (ANSICHAR*, const TCHAR*, size_t, bool) = nullptr;
	size_t(*ToTcharFunc) (TCHAR*, const ANSICHAR*, size_t, bool) = nullptr;
