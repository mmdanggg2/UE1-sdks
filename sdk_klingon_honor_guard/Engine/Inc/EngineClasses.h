...
public:
    ...
    void eventClientMessage(const TCHAR* S)
    {
        struct {TCHAR S[255]; } Parms;
...
public:
    ...
    TCHAR ProgressMessage[128];
    TCHAR ProgressMessageTwo[128];
    ...
    void eventClientTravel(const TCHAR* URL, BYTE TravelType, DWORD bItems)
    {
        struct {TCHAR URL[240]; BYTE TravelType; DWORD bItems; } Parms;
...
public:
    ...
    TCHAR Title[64];
    TCHAR Author[64];
    TCHAR LevelEnterText[64];
    TCHAR LocalizedPkg[64];
    TCHAR Pauser[32];
    DWORD bLonePlayer:1;
    DWORD bBegunPlay:1;
...
public:
    ...
    TCHAR MapPrefix[16];
    TCHAR BeaconName[15];
    TCHAR SpecialDamageString[64];
    TCHAR SwitchLevelMessage[64];
    INT SentText;
    TCHAR DefaultPlayerName[16];
    TCHAR LeftMessage[255];
    TCHAR FailedSpawnMessage[255];
    TCHAR FailedPlaceMessage[255];
    TCHAR NameChangedMessage[255];
    TCHAR EnteredMessage[255];
    ...
    class APlayerPawn* eventLogin(const TCHAR* Portal, const TCHAR* Options, TCHAR* Error, class UClass* SpawnClass)
    {
        struct {TCHAR Portal[32]; TCHAR Options[120]; TCHAR Error[80]; class UClass* SpawnClass; class APlayerPawn* ReturnValue; } Parms;
    ...
    void eventPreLogin(const TCHAR* Options, TCHAR* Error)
    {
        struct {TCHAR Options[120]; TCHAR Error[80]; } Parms;
        appStrncpy(Parms.Options,Options,120);
        appStrncpy(Parms.Error,Error,80);
        ProcessEvent(FindFunctionChecked(ENGINE_PreLogin),&Parms);
        appStrcpy(Error,Parms.Error);
    }
    void eventGetBeaconText(TCHAR* Result)
    {
        struct {TCHAR Result[240]; } Parms;
    ...
    void eventInitGame(const TCHAR* Options, TCHAR* Error)
    {
        struct {TCHAR Options[120]; TCHAR Error[80]; } Parms;
        appStrncpy(Parms.Options,Options,120);
        appStrncpy(Parms.Error,Error,80);
...
public:
    ...
    TCHAR HelpMessage[24][255];
    TCHAR MenuList[24][128];
    TCHAR LeftString[32];
    TCHAR RightString[32];
    TCHAR CenterString[32];
    TCHAR EnabledString[32];
    TCHAR DisabledString[32];
    TCHAR MenuTitle[32];
...
public:
    ...
    class UTexture* Icon;
    TCHAR M_Activated[32];
    TCHAR M_Selected[32];
    TCHAR M_Deactivated[32];
