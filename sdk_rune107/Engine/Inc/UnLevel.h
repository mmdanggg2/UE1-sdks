...
enum ETraceActorFlags
{
	...
	TRACE_TouchJoint	= 0x40, // If Trace hits a joint, send a TouchJoint() event to victim
	TRACE_HitJoint		= 0x80,	// If Trace hits a joint, send a HitJoint() event to victim
	TRACE_ShadowCast    = 0x100, // Check collision with actors that have bShadowCast set to true
	TRACE_OthersBlock	= 0x200, // RUNE:  Check collision with actors that have bBlocking set to true
	...
	TRACE_AllBlocking	= TRACE_Level | TRACE_Movers | TRACE_OthersBlock,
};
