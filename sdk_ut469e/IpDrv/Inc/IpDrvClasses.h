...
{
public:
    BYTE LinkMode GCC_PACK(INT_ALIGNMENT);
    void* Socket;
    INT Port;
    void* RemoteSocket;
...
{
public:
    BYTE LinkState GCC_PACK(INT_ALIGNMENT);
    FIpAddr RemoteAddr;
...
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,LinkMode)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,Socket)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,Port)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,RemoteSocket)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,PrivateResolveInfo)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,DataPending)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,ReceiveMode)
VERIFY_CLASS_OFFSET_NODIE(A,InternetLink,TextEncoding)
VERIFY_CLASS_SIZE_NODIE(AInternetLink)
VERIFY_CLASS_OFFSET_NODIE(A,TcpLink,LinkState)
VERIFY_CLASS_OFFSET_NODIE(A,TcpLink,RemoteAddr)
VERIFY_CLASS_OFFSET_NODIE(A,TcpLink,AcceptClass)
VERIFY_CLASS_OFFSET_NODIE(A,TcpLink,SendFIFO)
VERIFY_CLASS_SIZE_NODIE(ATcpLink)
VERIFY_CLASS_OFFSET_NODIE(A,UdpLink,BroadcastAddr)
