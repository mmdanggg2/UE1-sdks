...
// SkaarjTrooper.
//=============================================================================
class SkaarjTrooper extends Skaarj;
 	
#exec MESH IMPORT MESH=sktrooper ANIVFILE=MODELS\zaarj_a.3D DATAFILE=MODELS\zaarj_d.3D LODSTYLE=26 LODFRAME=406
...
#exec MESHMAP SETTEXTURE MESHMAP=sktrooper NUM=1 TEXTURE=UNREALI.STEffect.stshield
...
defaultproperties
{
     WeaponType=UnrealI.DispersionPistol
     LungeDamage=20
     SpinDamage=15
     ClawDamage=10
     CarcassType=UnrealI.TrooperCarcass
     RangedProjectile=None
     Health=170
     GroundSpeed=+00400.000000
     CombatStyle=+00000.300000
     Skin=UnrealI.sktrooper1
