...
inline bool FOpenGL3::SetVertexArray( T* DrawBuffer, GLuint StaticVBO, bool ForceUpdate)
{
	...
	if ( T::BufferTypes & (~FGL::DrawBuffer::BT_StaticBuffer) )
		check(DrawBuffer->GetStreamBuffer()->VBO); // checkSlow
	...
	if ( (T::BufferTypes & FGL::DrawBuffer::BT_StaticBuffer) && StaticVBO )
	{
		...
		if ( T::VBOType::HasStaticVertexData() )
			glVertexAttribPointer(0, T::VBOType::VertexArraySize(), T::VBOType::VertexArrayType(), GL_FALSE, Stride, BUFFER_OFFSET(T::VBOType::VertexOffset()) );
		if ( T::VBOType::HasStaticNormalData() )
			glVertexAttribPointer(6, T::VBOType::NormalArraySize(), T::VBOType::NormalArrayType(), GL_TRUE, Stride, BUFFER_OFFSET(T::VBOType::NormalOffset()) );
		if ( T::VBOType::HasStaticColor0Data() )
			glVertexAttribPointer(1, T::VBOType::Color0ArraySize(), T::VBOType::Color0ArrayType(), GL_TRUE, Stride, BUFFER_OFFSET(T::VBOType::Color0Offset()) );
		if ( T::VBOType::HasStaticColor1Data() )
			glVertexAttribPointer(2, T::VBOType::Color1ArraySize(), T::VBOType::Color1ArrayType(), GL_TRUE, Stride, BUFFER_OFFSET(T::VBOType::Color1Offset()) );
		if ( T::VBOType::HasStaticTexture0Data() )
			glVertexAttribPointer(3, T::VBOType::Texture0ArraySize(), T::VBOType::Texture0ArrayType(), GL_FALSE, Stride, BUFFER_OFFSET(T::VBOType::Texture0Offset()) );
		if ( T::VBOType::HasStaticTexture1Data() )
			glVertexAttribPointer(4, T::VBOType::Texture1ArraySize(), T::VBOType::Texture1ArrayType(), GL_FALSE, Stride, BUFFER_OFFSET(T::VBOType::Texture1Offset()) );
		if ( T::VBOType::HasStaticTexture2Data() )
			glVertexAttribPointer(5, T::VBOType::Texture2ArraySize(), T::VBOType::Texture2ArrayType(), GL_FALSE, Stride, BUFFER_OFFSET(T::VBOType::Texture2Offset()) );
		if ( T::VBOType::HasStaticVertexParam0Data() )
			glVertexAttribPointer(9, T::VBOType::VertexParam0ArraySize(), T::VBOType::VertexParam0ArrayType(), GL_FALSE, Stride, BUFFER_OFFSET(T::VBOType::VertexParam0Offset()) );
		if ( T::VBOType::HasStaticVertexParam1Data() )
			glVertexAttribPointer(10, T::VBOType::VertexParam1ArraySize(), T::VBOType::VertexParam1ArrayType(), GL_FALSE, Stride, BUFFER_OFFSET(T::VBOType::VertexParam1Offset()) );
	...
	glBindBuffer(GL_ARRAY_BUFFER, DrawBuffer->GetStreamBuffer()->GetBufferObject());
	...
	{
		glVertexAttribPointer(0, T::VertexType::ArraySize, T::VertexType::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(0);
		Offset += sizeof(typename T::VertexType);
	}
	if ( HAS_ATTRIB(BT_Color0) ) // 1
	{
		glVertexAttribPointer(1, T::Color0Type::ArraySize, T::Color0Type::ArrayType, GL_TRUE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(1);
		Offset += sizeof(typename T::Color0Type);
	}
	if ( HAS_ATTRIB(BT_Color1) ) // 2
	{
		glVertexAttribPointer(2, T::Color1Type::ArraySize, T::Color1Type::ArrayType, GL_TRUE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(2);
		Offset += sizeof(typename T::Color1Type);
	}
	if ( HAS_ATTRIB(BT_Texture0) ) // 3
	{
		glVertexAttribPointer(3, T::Texture0Type::ArraySize, T::Texture0Type::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(3);
		Offset += sizeof(typename T::Texture0Type);
	}
	if ( HAS_ATTRIB(BT_Texture1) ) // 4
	{
		glVertexAttribPointer(4, T::Texture1Type::ArraySize, T::Texture1Type::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(4);
		Offset += sizeof(typename T::Texture1Type);
	}
	if ( HAS_ATTRIB(BT_Texture2) ) // 5
	{
		glVertexAttribPointer(5, T::Texture2Type::ArraySize, T::Texture2Type::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(5);
		Offset += sizeof(typename T::Texture2Type);
	}
	if ( HAS_ATTRIB(BT_Normal) ) // 6
	{
		glVertexAttribPointer(6, T::NormalType::ArraySize, T::NormalType::ArrayType, GL_TRUE, Stride, BUFFER_OFFSET(Offset));
	...
	if ( HAS_ATTRIB(BT_TextureLayers) ) // 7
	{
		if ( IsIntAttrib(T::TextureLayersType::ArrayType) )
			glVertexAttribIPointer(7, T::TextureLayersType::ArraySize, T::TextureLayersType::ArrayType, Stride, BUFFER_OFFSET(Offset));
		else
			glVertexAttribPointer(7, T::TextureLayersType::ArraySize, T::TextureLayersType::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
	...
	if ( HAS_ATTRIB(BT_LightInfo) ) // 8
	{
		if ( IsIntAttrib(T::LightInfoType::ArrayType) )
			glVertexAttribIPointer(8, T::LightInfoType::ArraySize, T::LightInfoType::ArrayType, Stride, BUFFER_OFFSET(Offset));
		else
			glVertexAttribPointer(8, T::LightInfoType::ArraySize, T::LightInfoType::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
	...
	if ( HAS_ATTRIB(BT_VertexParam0) ) // 9
	{
		if ( IsIntAttrib(T::VertexParam0Type::ArrayType) )
			glVertexAttribIPointer(9, T::VertexParam0Type::ArraySize, T::VertexParam0Type::ArrayType, Stride, BUFFER_OFFSET(Offset));
		else
			glVertexAttribPointer(9, T::VertexParam0Type::ArraySize, T::VertexParam0Type::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(9);
	...
	if ( HAS_ATTRIB(BT_VertexParam1) ) // 10
	{
		if ( IsIntAttrib(T::VertexParam1Type::ArrayType) )
			glVertexAttribIPointer(10, T::VertexParam1Type::ArraySize, T::VertexParam1Type::ArrayType, Stride, BUFFER_OFFSET(Offset));
		else
			glVertexAttribPointer(10, T::VertexParam1Type::ArraySize, T::VertexParam1Type::ArrayType, GL_FALSE, Stride, BUFFER_OFFSET(Offset));
		glEnableVertexAttribArray(10);
	...
	if ( DrawBuffer->GetIndexBuffer()->bBufferObject && DrawBuffer->GetIndexBuffer() )
	{
		glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, DrawBuffer->GetIndexBuffer()->GetBufferObject());
	}
