...
var config string OnlineServices[30];

var UWindowPulldownMenuItem OnlineServiceItems[ArrayCount(OnlineServices)];
var string OnlineServiceCmdType[ArrayCount(OnlineServices)];
var string OnlineServiceCmdAction[ArrayCount(OnlineServices)];
var string OnlineServiceHelp[ArrayCount(OnlineServices)];
...
function Created()
{
	...
	for (i = 0; i < ArrayCount(OnlineServices); i++)
	{
		if(OnlineServices[i] == "")
			break;
