...
function Created()
{
	...
	local class<UTExtraKeyBindings> BindingClass;
	...
	NextBindingClass = GetPlayerOwner().GetNextInt("UTMenu.UTExtraKeyBindings", 0);
	if(NextBindingClass != "")
	{
		while( (NextBindingClass != "") && (NumBindingClasses < 50) && (i < ArrayCount(AliasNames)) )
		{
			BindingClass = class<UTExtraKeyBindings>(DynamicLoadObject(NextBindingClass, class'Class'));
			...
			NumBindingClasses++;
			NextBindingClass = GetPlayerOwner().GetNextInt("UTMenu.UTExtraKeyBindings", NumBindingClasses);
		}
	}
...
defaultproperties
{
	...
	AliasNames(64)="ShowServerInfo"
	AliasNames(65)="ShowObjectives"
	...
	LabelList(55)="Other / Misc,Screenshot"
	LabelList(56)="Suicide"
	LabelList(57)="Reconnect as Player"
	LabelList(58)="Reconnect as Spectator"
	LabelList(59)="Play on Red Team"
	LabelList(60)="Play on Blue Team"
	LabelList(61)="Play on Green Team"
	LabelList(62)="Play on Gold Team"
	LabelList(63)="Toggle Scoreboard"
	LabelList(64)="Toggle Server Info"
	LabelList(65)="Toggle Objectives"
	VoiceKeyNumber=19
	ConsoleKeyNumber=53
}
