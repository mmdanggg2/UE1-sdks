...
public:
    ...
    BYTE FOVFix;
    FLOAT WeaponFOVScale;
    FLOAT DesiredNarrowFOV;
    INT StoredCanvasX;
    INT StoredCanvasY;
...
AUTOGENERATE_FUNCTION(AGameInfo,-1,execGetMutatorList);
...
VERIFY_CLASS_OFFSET_NODIE(A,PlayerPawn,CheatFlyingSpeed)
...
VERIFY_CLASS_OFFSET_NODIE(A,PlayerPawn,FOVFix)
VERIFY_CLASS_OFFSET_NODIE(A,PlayerPawn,WeaponFOVScale)
VERIFY_CLASS_OFFSET_NODIE(A,PlayerPawn,DesiredNarrowFOV)
VERIFY_CLASS_OFFSET_NODIE(A,PlayerPawn,StoredCanvasX)
VERIFY_CLASS_OFFSET_NODIE(A,PlayerPawn,StoredCanvasY)
