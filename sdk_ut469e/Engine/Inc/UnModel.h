...
// Higor: Remove once static geometry buffering implementation is final
#define PROTOTYPE_STATIC_GEOMETRY_BUFFERING
...
class ENGINE_API UModel : public UPrimitive
{
	...
	void EmptyModel( INT EmptySurfInfo, INT EmptyPolys, UBOOL bNoRealloc = FALSE );
	void ShrinkModel();
