...
class ENGINE_API UPalette : public UObject
{
	...
	BYTE AddColorOrFindBestMatch( FColor Color, INT First );
...
class ENGINE_API UTexture : public UBitmap
{
	...
	// Texture used by editor as texture for all surfaces when option SHOW_TextureGrid active
	static UTexture* TextureGrid;
