...
inline UBOOL AActor::IsStaticBrush() const { return Brush != NULL &&  bStatic	&& IsA(ABrush::StaticClass()); }
inline UBOOL AActor::IsMovingBrush() const { return Brush != NULL && !bStatic	&& IsA(ABrush::StaticClass()); }
