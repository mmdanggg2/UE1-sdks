...
public:
	...
	{
		//!!! FIXME: what was this supposed to be...?  --ryan.
		//*this << *(DWORD*)Value;
		*this << Value;
	}
	...
	,	ArForServer		(1)
	,   ArIsError       (0)
	,	ArIsCriticalError(0) //elmuerte: security fix
	...
	friend FArchive& operator<<(FArchive& Ar, TCHAR& S)
	{
	...
	// if TCHAR is an unsigned short, this next definition conflicts with the TCHAR-based operator defined above...
	#if !defined(_MSC_VER) || BUILD_64
	...
	friend FArchive& operator<<(FArchive& Ar, void*& P)
	{
