...
//
// stijn: Lets the actor recompilation code use a worklist rather than 
// recursively traverse through objects whose outgoing references need 
// to be updated
//
#define OLDUNREAL_RECOMPILATION_USE_WORKLIST_REF_UPDATES 1
...
//
// stijn: Lets the garbage collector use a worklist rather than recursively 
// traverse through objects. This should be marginally slower than the original
// garbage collector, but it also massively reduces the worst-case stack memory 
// usage and size
//
#define OLDUNREAL_USE_WORKLIST_GC 1
