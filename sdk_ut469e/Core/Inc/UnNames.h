...
REGISTER_NAME(  25, WinDrv           )
REGISTER_NAME(  26, SDLDrv           )
REGISTER_NAME(  27, Botpack          )
...
REGISTER_NAME( 164, AnnouncerSpectator)
...
#ifdef UTPG_MD5
REGISTER_NAME( 795, DevMD5)
#endif
REGISTER_NAME( 796, DevPhysics)
REGISTER_NAME( 797, DevInput)
...
// Botpack.Kicker network compatibility hack
#if OLDUNREAL_USE_KICKER_HACK
REGISTER_NAME(841, Kicker)
REGISTER_NAME(842, KickVelocity)
REGISTER_NAME(843, KickedClasses)
REGISTER_NAME(844, bKillVelocity)
#endif
