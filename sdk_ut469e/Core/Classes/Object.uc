...
native static final function bool GetDefaultValue( out string PropValue, Object Obj, string PropName, optional int ArrayIndex ); // stijn: reads a property value from the default ini for ObjectClass
