class UWindowURLTextArea expands UWindowDynamicTextArea;
...
function TextAreaClipText(Canvas C, float DrawX, float DrawY, coerce string S, optional bool bCheckHotkey)
{
	...
	while(Text != "")
	{
		...
		Super.TextAreaClipText(C, DrawX, DrawY, NextBlock);
		DrawX += W;
	}
}
