...
var transient float SavedWidth[7];
var transient Font SavedFont[7];
var float FontDiv[7];
...
var transient bool bCacheSetup;
...
var transient array<FontCache> CachedFonts;
...
function Font GetFontBySize(float IdealSize)
{
	...
	// Recreate the font cache when we load a save game
	if (CachedFonts.Length == 0 &&
	   !bCacheSetup &&
	   bEnableInGameScaling)
	{
	   SetScalingState( bEnableInGameScaling );
	}
