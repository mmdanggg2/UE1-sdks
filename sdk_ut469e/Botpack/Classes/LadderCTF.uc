...
// LadderCTF
//=============================================================================
class LadderCTF extends Ladder;
...
defaultproperties
{
	...
	GoalTeamScore(1)=3
	RankedGame(1)=1
	MatchInfo(1)="Botpack.RatedMatchCTF1"
	...
	RankedGame(2)=2
	GoalTeamScore(2)=3
	MatchInfo(2)="Botpack.RatedMatchCTF3"
	...
	RankedGame(3)=2
	GoalTeamScore(3)=3
	MatchInfo(3)="Botpack.RatedMatchCTF2"

	Maps(4)="Coret.unr"
	MapTitle(4)="Coret"
	MapAuthors(4)="Alan Willard 'Talisman'"
	...
	RankedGame(4)=3
	GoalTeamScore(4)=3
	MatchInfo(4)="Botpack.RatedMatchCTF4"
	...
	RankedGame(5)=3
	GoalTeamScore(5)=3
	MatchInfo(5)="Botpack.RatedMatchCTF5"
	...
	RankedGame(6)=4
	GoalTeamScore(6)=3
	MatchInfo(6)="Botpack.RatedMatchCTF6"
	...
	RankedGame(7)=4
	GoalTeamScore(7)=3
	MatchInfo(7)="Botpack.RatedMatchCTF7"
	...
	RankedGame(8)=5
	GoalTeamScore(8)=3
	MatchInfo(8)="Botpack.RatedMatchCTF8"
