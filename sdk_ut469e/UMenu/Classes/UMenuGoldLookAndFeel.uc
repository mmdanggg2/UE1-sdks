...
function Button_DrawSmallButton( UWindowSmallButton B, Canvas C)
{
	...
	if      ( B.bDisabled || !B.IsActive() )  Y = 34;
...
defaultproperties 
{
	Active=Texture'UMenu.GoldActiveFrame'
	Inactive=Texture'UMenu.GoldInactiveFrame'
	ActiveS=Texture'UMenu.GoldActiveFrameS'
	InactiveS=Texture'UMenu.GoldInactiveFrameS'
	Misc=Texture'UMenu.Misc'
	SmallButton=Texture'UMenu.GoldButton'
	
	ActiveHiRes=Texture'UMenu.GoldActiveFrameHiRes'
	ActiveSHiRes=Texture'UMenu.GoldActiveFrameHiRes'
	InActiveHiRes=Texture'UMenu.GoldInactiveFrameHiRes'
	InActiveSHiRes=Texture'UMenu.GoldInactiveFrameHiRes'
	ActiveHiResScale=8.0
	ActiveSHiResScale=8.0
	InactiveHiResScale=8.0
	InactiveSHiResScale=8.0
