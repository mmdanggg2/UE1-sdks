...
defaultproperties 
{
	Active=Texture'UMenu.BlueActiveFrame'
	Inactive=Texture'UMenu.BlueInactiveFrame'
	ActiveS=Texture'UMenu.BlueActiveFrameS'
	InactiveS=Texture'UMenu.BlueInactiveFrameS'
	Misc=Texture'UMenu.BlueMisc'
	SmallButton=Texture'UMenu.BlueButton'

	ActiveHiRes=Texture'UMenu.BlueActiveFrameHiRes'
	ActiveSHiRes=Texture'UMenu.BlueActiveFrameHiRes'
