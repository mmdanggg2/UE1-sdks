...
public:
	...
	virtual FPlane Fog( FTransSample& Point )=0;
...
#ifdef RENDER_MODULE
	#undef STAT
	// Condition here must be with negate variable, for make CPU branch predictor happy
	#define STAT(x) if (!GStat.SkipStats) { x ; }
#endif // RENDER_MODULE
#endif // STATS
...
class RENDER_API URender : public URenderBase
{
	...
	// DrawLodMesh variables and structures
	...
	TArray<FMeshFloatUV> WedgeExtPool;
