...
class ENGINE_API UPrimitive : public UObject
{
	...
	virtual FBox GetCollisionBoundingBox( const AActor* Owner, UBOOL Exact ) const;
	virtual FVector GetCollisionExtent(const AActor* Owner) const;
	virtual void DrawCollisionBounds(AActor*, class URenderBase*, struct FSceneNode*, FPlane, unsigned long);
	virtual void ValidateActor(AActor*);
};
