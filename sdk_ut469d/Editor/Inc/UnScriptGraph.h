...
// Used for error logging if a resolve during digestion failed.
	...
	#define GDigestResolveError GWarn
#else
	#define GDigestResolveError GError
#endif
...
struct FStructIntrospectionInfo : public FFieldIntrospectionInfo
{
...
struct FFunctionIntrospectionInfo : public FStructIntrospectionInfo
{
...
struct FStateIntrospectionInfo : public FStructIntrospectionInfo
{
...
struct FClassIntrospectionInfo : public FStateIntrospectionInfo
{
...
struct FReplicationIntrospectionInfo : public FIntrospectionInfoBase
{
	// Variables;
