	...
	if ( (ActiveDrawBuffer != (void*)DrawBuffer) || ActiveDrawBufferAttribs != DrawBuffer->ActiveAttribs )
	{
		...
		if ( (T::BufferTypes & BT_StaticBuffer) && StaticVBO )
		{
			...
			if ( T::VBOType::HasStaticVertexData() )
				glVertexPointer( T::VBOType::VertexArraySize(), T::VBOType::VertexArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::VertexOffset()) );
			if ( T::VBOType::HasStaticNormalData() )
				glNormalPointer( T::VBOType::NormalArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::NormalOffset()) );
			if ( T::VBOType::HasStaticColor0Data() )
				glColorPointer( T::VBOType::Color0ArraySize(), T::VBOType::Color0ArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::Color0Offset()) );
			if ( T::VBOType::HasStaticColor1Data() )/*SECONDARY COLOR DOES NOT SUPPORT ALPHA*/
				glSecondaryColorPointerEXT( 3, T::VBOType::Color1ArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::Color1Offset()) );
			if ( T::VBOType::HasStaticTexture0Data() )
				glTexCoordPointer( T::VBOType::Texture0ArraySize(), T::VBOType::Texture0ArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::Texture0Offset()) );
			if ( T::VBOType::HasStaticTexture1Data() )
			{
				glClientActiveTextureARB(GL_TEXTURE1_ARB);
				glTexCoordPointer( T::VBOType::Texture1ArraySize(), T::VBOType::Texture1ArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::Texture1Offset()) );
			}
			if ( T::VBOType::HasStaticTexture2Data() )
			{
				glClientActiveTextureARB(GL_TEXTURE2_ARB);
				glTexCoordPointer( T::VBOType::Texture2ArraySize(), T::VBOType::Texture2ArrayType(), sizeof(typename T::VBOType), BUFFER_OFFSET(T::VBOType::Texture2Offset()) );
			}
		...
		DWORD Offset = 0;
		BYTE* Buffer = DrawBuffer->GetBuffer()->Data;
		INT TMU = 0;

		#define HAS_ATTRIB(bt) ((T::ForceAttribs & bt) || ((T::BufferTypes & bt) & ActiveDrawBufferAttribs) )
		if ( HAS_ATTRIB(BT_Vertex) )
		{
			glVertexPointer( T::VertexType::ArraySize, T::VertexType::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
			Offset += sizeof(typename T::VertexType);
		}
		if ( HAS_ATTRIB(BT_Normal) )
		{
			glNormalPointer( T::NormalType::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
			Offset += sizeof(typename T::NormalType);
		}
		if ( HAS_ATTRIB(BT_Color0) )
		{
			glColorPointer( T::Color0Type::ArraySize, T::Color0Type::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
			Offset += sizeof(typename T::Color0Type);
		}
		if ( HAS_ATTRIB(BT_Color1) )
		{
			glSecondaryColorPointerEXT( 3, T::Color1Type::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
			Offset += sizeof(typename T::Color1Type);/*SECONDARY COLOR DOES NOT SUPPORT ALPHA*/
		}
		if ( HAS_ATTRIB(BT_Texture0) )
		{
			glTexCoordPointer( T::Texture0Type::ArraySize, T::Texture0Type::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
		...
		if ( HAS_ATTRIB(BT_Texture1) )
		{
			TMU = 1;
			glClientActiveTextureARB(GL_TEXTURE1_ARB);
			glTexCoordPointer( T::Texture1Type::ArraySize, T::Texture1Type::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
		...
		if ( HAS_ATTRIB(BT_Texture2) )
		{
			TMU = 2;
			glClientActiveTextureARB(GL_TEXTURE2_ARB);
			glTexCoordPointer( T::Texture2Type::ArraySize, T::Texture2Type::ArrayType, DrawBuffer->BufferStride, Buffer + Offset);
			Offset += sizeof(typename T::Texture2Type);
		}
		//check(Offset == DrawBuffer->BufferStride);
		#undef HAS_ATTRIB
