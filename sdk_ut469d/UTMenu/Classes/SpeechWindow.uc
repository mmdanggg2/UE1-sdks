...
{
	return KeyEventHandler(Key, Action, Delta);
}
	
function bool KeyEventHandler( byte Key, byte Action, FLOAT Delta, optional int OptionOffset )
{
	local byte B;

	// ignore IK_Escape while in the SpeechWindow
	if ( Key == 27 )
	    return true;
