...
// Memory allocator.
// stijn: fmallocansi is thread safe and slightly faster than the old fmallocwindows
...
INT WINAPI WinMain( HINSTANCE hInInstance, HINSTANCE hPrevInstance, char*, INT nCmdShow )
{
	...
	try
	{
		...
		appInit( GPackage, *appPlatformBuildCmdLine(1), &Malloc, &Log, &Error, &Warn, &FileManager, FConfigCacheIni::Factory, 1 );
