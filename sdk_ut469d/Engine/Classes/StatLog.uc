...
function string GetAbsoluteTime()
{
	...
	if (Level.Month < 10)
		...
		AbsoluteTime $= "."$Level.Month;

	if (Level.Day < 10)
		AbsoluteTime $= ".0"$Level.Day;
	else
		AbsoluteTime $= "."$Level.Day;

	if (Level.Hour < 10)
		AbsoluteTime $= ".0"$Level.Hour;
	else
		AbsoluteTime $= "."$Level.Hour;

	if (Level.Minute < 10)
		AbsoluteTime $= ".0"$Level.Minute;
	else
		AbsoluteTime $= "."$Level.Minute;

	if (Level.Second < 10)
		AbsoluteTime $= ".0"$Level.Second;
	else
		AbsoluteTime $= "."$Level.Second;

	if (Level.Millisecond < 10)
		AbsoluteTime $= ".0"$Level.Millisecond;
	else
		AbsoluteTime $= "."$Level.Millisecond;
