...
//	
//  TODO: We should enable this when we can finally build our Linux clients with
//  ICONV_SET_DISCARD_ILSEQ enabled. Until then, we have no choice but to use use
//  compatibility mode
//
