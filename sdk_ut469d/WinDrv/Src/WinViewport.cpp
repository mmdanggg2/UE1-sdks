...
void UWindowsViewport::UpdateWindowFrame()
{
	...
	{
		case REN_Wire:		WindowName = LocalizeGeneral("ViewPersp"); break;
		case REN_OrthXY:	WindowName = LocalizeGeneral("ViewXY"   ); break;
		case REN_OrthXZ:	WindowName = LocalizeGeneral("ViewXZ"   ); break;
		case REN_OrthYZ:	WindowName = LocalizeGeneral("ViewYZ"   ); break;
		default:			WindowName = LocalizeGeneral("ViewOther"); break;
	}
