...
// Manta.
//=============================================================================
class Manta extends ScriptedPawn;
...
defaultproperties
{
     ...
     WhipDamage=20
	 Health=78
     Whip=UnrealShare.whip1m
     wingBeat=UnrealShare.fly1m
     Sting=UnrealShare.sting1m
     CarcassType=UnrealShare.MantaCarcass
     Aggressiveness=+00000.200000
     ReFireRate=+00000.500000
     WalkingSpeed=+00000.600000
     bIsWuss=True
     Acquire=UnrealShare.call1m
     Fear=UnrealShare.injur2m
     Roam=UnrealShare.call2m
     Threaten=UnrealShare.call2m
     ...
     JumpZ=+00010.000000
     HitSound1=UnrealShare.injur1m
     HitSound2=UnrealShare.injur2m
     Land=UnrealShare.land1mt
     Die=UnrealShare.death2m
     WaterStep=None
     CombatStyle=-00000.300000
     DrawType=DT_Mesh
     Mesh=UnrealShare.Manta1
